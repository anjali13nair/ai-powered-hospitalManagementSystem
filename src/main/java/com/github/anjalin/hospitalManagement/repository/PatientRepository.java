...
import com.github.anjalin.hospitalManagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.github.anjalin.hospitalManagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
